package t.me.p1azmer.plugin.regioncommand.utils.vector;
...
import static t.me.p1azmer.plugin.regioncommand.utils.vector.BitMath.*;
...
public final class BlockVector3 {
    ...
    public static BlockVector3 at(Location location){
